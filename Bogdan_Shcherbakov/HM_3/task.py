...
def rated_films():
    ...
    print(f"Общее число оценненых фильмов {num_of_rated_films}")
...
def most_active_userId():
    ...
    print(f"Пользователь {user_id} поставил большее колличесвто оценок в количестве {num_of_rating}")
...
def most_rated_film():
    ...
    print(f"Самому оценненому фильму {film_id} поставили больше всего оценок в количестве {num_of_rating}")
